...
export function Hero() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="min-h-screen flex items-center justify-center px-6 lg:px-8 relative overflow-hidden pt-16 lg:pt-0"
    >
      ...
      <div className="max-w-4xl w-full relative z-10">
        <div className="space-y-8">
          ...
          >
            <div className="flex items-center gap-3 mb-6 group cursor-pointer">
              <div className="relative">
                <Sparkles className="text-primary group-hover:rotate-45 transition-transform duration-300" size={20} />
            ...
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight text-balance space-y-2">
              <div>Construindo</div>
              <div className="gradient-text animate-glow">soluções inteligentes</div>
              <div className="flex items-center gap-3">
                com{" "}
                <span className="inline-flex items-center gap-2 text-primary">
                  IA <Zap size={40} className="animate-pulse" />
                </span>
              </div>
            </h1>
          </div>
          ...
          <p
            className={`text-lg lg:text-xl text-muted-foreground max-w-2xl text-balance leading-relaxed transition-all duration-700 delay-100 ${
              isVisible ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"
            }`}
          >
          ...
          <div
            className={`flex flex-wrap gap-4 pt-8 transition-all duration-700 delay-200 ${
              isVisible ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"
            }`}
          >
            <a
              href="#projects"
              className="group relative px-8 py-4 bg-gradient-to-r from-primary to-accent text-primary-foreground rounded-lg font-semibold overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-primary/50"
            >
            ...
            <a
              href="#contact"
              className="px-8 py-4 glass-dark rounded-lg font-semibold transition-all duration-300 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/10 hover:scale-105"
            >
              Entrar em Contato
            </a>
          </div>
